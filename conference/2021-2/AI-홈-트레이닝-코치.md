...
:::note 개요 사용자의 현재 운동 동작에 대해 횟수 카운트, 자세 교정과 같은 실시간 피드백을 제공하는 온디바이스 어플리케이션 제작 :::

\`\`\`mdx-code-block

import ReactPlayer from 'react-player';

<ReactPlayer url="[https://youtu.be/CPEmuL4OfqU](https://youtu.be/CPEmuL4OfqU "https://youtu.be/CPEmuL4OfqU")" />
